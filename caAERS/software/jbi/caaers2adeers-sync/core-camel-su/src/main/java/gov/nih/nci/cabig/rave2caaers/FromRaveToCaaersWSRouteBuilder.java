...
public class FromRaveToCaaersWSRouteBuilder {
	...
	public void configure(Caaers2AdeersRouteBuilder rb){
        ...
        configureWSCallRoute("direct:caaers-generateSafetyReportIdService-sync", caAERSGenerateReportIdServiceJBIURL + "generateSafetyReportId" );
        //caAERS - call generate SAE Evaluation service
        configureWSCallRoute("direct:caaers-saveAndEvaluateAEs-sync", caAERSSAEEvaluationServiceJBIURL + "saveAndEvaluateAEs" );
        //caAERS - call Submit Safety Report service 
        configureWSCallRoute("direct:caaers-submitSafetyReport-sync", caAERSSafetyReportServiceJBIURL + "submitSafetyReport" );
        //caAERS - call Initiate Safety Report service 
        configureWSCallRoute("direct:caaers-initiateSafetyReportAction-sync", caAERSSafetyReportServiceJBIURL + "initiateSafetyReportAction" );
	}
	

	private void configureWSCallRoute(String fromSink, String serviceURI){
