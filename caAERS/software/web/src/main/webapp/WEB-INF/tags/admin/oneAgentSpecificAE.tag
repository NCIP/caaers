...
<td><ui:text path="agentSpecificTerms[${index}].grade1Frequency" readonly="false" size="3" maxlength="6" pattern="\d(\d)?(\.\d(\d)?)?"/>%</td>
<td><ui:text path="agentSpecificTerms[${index}].grade2Frequency" readonly="false" size="3" maxlength="6" pattern="\d(\d)?(\.\d(\d)?)?"/>%</td>
<td><ui:text path="agentSpecificTerms[${index}].grade3Frequency" readonly="false" size="3" maxlength="6" pattern="\d(\d)?(\.\d(\d)?)?"/>%</td>
<td><ui:text path="agentSpecificTerms[${index}].grade4Frequency" readonly="false" size="3" maxlength="6" pattern="\d(\d)?(\.\d(\d)?)?"/>%</td>
<td><ui:text path="agentSpecificTerms[${index}].grade5Frequency" readonly="false" size="3" maxlength="6" pattern="\d(\d)?(\.\d(\d)?)?"/>%</td>
