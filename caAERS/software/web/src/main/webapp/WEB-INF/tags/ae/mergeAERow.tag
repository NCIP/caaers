...
<%@attribute name="cssClass"  %>
    ...
    <tr id="aemrg-${widgetId}-tr-iae" class="tr-ae1 ${cssClass}">
        <td width="${requestScope.widthSource}" class="td-ae1 ${cssClass}" >${ae1.source}</td>
        <td width="${requestScope.widthId}" class="td-ae1 ${cssClass}" >${empty ae1.externalID ? dash : ae1.externalID }</td>
        <td width="${requestScope.widthTerm}" class="td-ae1 col-term-${widgetId} ${cssClass}" >
            <c:if test="${t1 ne t2}">
        ...
        <td width="${requestScope.widthGrade}" class="td-ae1 col-grade-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthStartDate}" class="td-ae1 col-startDate-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthEndDate}" class="td-ae1 col-endDate-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthVerbatim}" class="td-ae1 col-v-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthWhySerious}" class="td-ae1 col-whySerious-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthAttribution}" class="td-ae1 col-attribution-${widgetId} ${cssClass}" >
    ...
    <tr id="aemrg-${widgetId}-tr-eae" class="tr-ae2 ${cssClass}">
        <td width="${requestScope.widthSource}" class="td-ae2 ${cssClass}" >${ae2.source}</td>
        <td width="${requestScope.widthId}" class="td-ae2 ${cssClass}" >${empty ae2.externalID ? dash : ae2.externalID }</td>
        <td width="${requestScope.widthTerm}" class="td-ae2 col-term-${widgetId} ${cssClass}" >
            <c:if test="${t1 ne t2}">
        ...
        <td width="${requestScope.widthGrade}" class="td-ae2 col-grade-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthStartDate}" class="td-ae2 col-startDate-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthEndDate}" class="td-ae2 col-endDate-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthVerbatim}" class="td-ae2 col-v-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthWhySerious}" class="td-ae2 col-whySerious-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthAttribution}" class="td-ae2 col-attribution-${widgetId} ${cssClass}" >
    ...
    <tr id="aemrg-${widgetId}-tr-mae"  class="tr-ae3 ${cssClass}" >
        <td width="${requestScope.widthSource}" class="td-ae3 ${cssClass}" >&nbsp;&nbsp;&nbsp;
        ...
        <td width="${requestScope.widthId}"  class="td-ae3 ${cssClass}"  >${empty ae2.externalID ? dash : ae2.externalID }</td>
        ...
        <td width="${requestScope.widthGrade}" id="td-grade${widgetId}"  class="td-ae3 col-grade-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthStartDate}" id="td-startDate${widgetId}" class="td-ae3 col-startDate-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthEndDate}" id="td-endDate${widgetId}"  class="td-ae3 col-endDate-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthVerbatim}" id="td-verbatim${widgetId}" class="td-ae3 col-v-${widgetId} ${cssClass}" >
                ${( (v1 eq v3) || (v2 eq v3)) ? (empty v3 ? dash : v3) : (empty v1 and empty v2) ? dash : '<div id="col-v-${widgetId}" class="selectAbove">Select above </div>'}
        </td>
        <td width="${requestScope.widthWhySerious}" id="td-whySerious${widgetId}"  class="td-ae3 col-whySerious-${widgetId} ${cssClass}" >
        ...
        <td width="${requestScope.widthAttribution}" id="td-attribution${widgetId}" class="td-ae3 col-attribution-${widgetId} ${cssClass}" >
