...
<div id="divStudySync" style="display:none;">
    ${_syncpopmsg}
    <img height="13px" width="13px" src="<c:url value="/images/indicator.gif" />" alt="activity indicator" width="20px" height="20px"/>
</div>
<script type="text/javascript">
    ...
    Event.observe(window, "load", function(){
        Dialog.info($('divStudySync').innerHTML, {className: "alphacube", width:600});
        //
        createStudy.syncStudyWithAdEERS(studyIdentifierValue, sponsorNCICode ,"UPDATE", function(_resultId) {
            Dialog.closeInfo();
        });
