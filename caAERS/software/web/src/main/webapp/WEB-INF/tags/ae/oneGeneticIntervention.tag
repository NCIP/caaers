...
<ae:fieldGroupDivision fieldGroupFactoryName="geneticIntervention" index="${index}" enableDelete="true" deleteParams="'genetic', ${index}, '_genetics'" collapsed="${!empties[v] && collapsed}">
