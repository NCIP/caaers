		...
		<td width="20%" id="action${report.id}" align="center">
            ...
            <div id="options-actions-menu-${report.id}" style="display: none;">
                <ul>
                    ...
                    <li><a href="#" onclick="doIt('dcpSAEPDFType', '${report.id}', '${report.aeReport.id}', '${lastVersion.submissionUrl}')"><img src="<chrome:imageUrl name="../blue/pdf.png"/>" alt=""/>&nbsp;Export DCP SAE PDF</a></li>
                    <li><a href="#" onclick="doIt('ciomsPDFType', '${report.id}', '${report.aeReport.id}', '${lastVersion.submissionUrl}')"><img src="<chrome:imageUrl name="../blue/pdf.png"/>" alt=""/>&nbsp;Export CIOMS PDF</a></li>
                    <li><a href="#" onclick="doIt('ciomsSaePDFType', '${report.id}', '${report.aeReport.id}', '${lastVersion.submissionUrl}')"><img src="<chrome:imageUrl name="../blue/pdf.png"/>" alt=""/>&nbsp;Export DCP Safety Report PDF</a></li>
