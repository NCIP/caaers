...
<%@attribute name="title" required="true" description="The title of the accordion." fragment="true" %>
...
<div id="${id}" class="accordion-toggle accordion-title ${cssClass}"><jsp:invoke fragment="title" /></div><div id="accordionContent-${id}" class="accordion-content ${cssClass}"><jsp:doBody/></div>
</caaers:renderFilter>