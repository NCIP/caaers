...
//            var html = html.interpolate({strId:strId, rt:rt, un:un});
        ...
        var actionsRowOneItem = "<span id='studyLink#{index}'><a onclick='doUpdate(\"#{fsid}\", \"#{index}\", \"#{ncic}\", \"CREATE\")' id='_study#{index}' class='submitterButton submitter fg-button fg-button-icon-right ui-widget ui-state-default ui-corner-all'>Import<span class='ui-icon ui-icon-triangle-1-s' style='display:none;'></span></a></span>";
