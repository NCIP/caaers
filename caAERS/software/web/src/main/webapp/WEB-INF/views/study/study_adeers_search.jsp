...
<script language="JavaScript">
    ...
    * BEN, alphacube is the skin of the Windows that opnes... that gray one with an orange bar on it
    ...
    function submitSearch() {
        ...
        popupDiv = new Window({className:"alphacube", width:800, height:110, zIndex:100, resizable:false, recenterAuto:true, draggable:false, closable:false, minimizable:false, maximizable:false});
...
*/
        popupDiv = new Window({className:"alphacube", width:800, height:110, zIndex:100, resizable:true, recenterAuto:true, draggable:true, closable:true, minimizable:false, maximizable:false});
