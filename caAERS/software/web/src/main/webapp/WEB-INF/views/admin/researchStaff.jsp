        ...
        <div class="tabpane">
            <div class="workflow-tabs2">
                <ul id="" class="tabs autoclear">
                    <c:if test="${hasRSCreate and hasRSUpdate}"><li id="thirdlevelnav" class="selected"><div><a href="createResearchStaff"><caaers:message code="researchstaff.menu.createEditResearchStaff"/></a></div></li></c:if>
