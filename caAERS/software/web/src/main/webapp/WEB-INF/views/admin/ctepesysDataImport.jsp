...
<script language="JavaScript" type="text/JavaScript">
	...
	var fillerData =  [{name:'CTCAE',lastSuccessfulUpdate:'${empty command.ctcaeLastSuccessfullyUpdated ? "never":command.ctcaeLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.ctcaeLastUpdated ? "never":command.ctcaeLastUpdatedStr}  <div> <img class="indicator" id="ctcaeIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div> </div>',select: '<input type="checkbox" name="ctcaeChecked" id="ctcaeChecked" value="ctcaeChecked"/>'},
						{name:'Devices',lastSuccessfulUpdate:'${empty command.devicesLastSuccessfullyUpdated ? "never":command.devicesLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.devicesLastUpdated ? "never":command.devicesLastUpdatedStr} <div> <img class="indicator" id="deviceIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div> </div>',select:'<input type="checkbox" name="deviceChecked" id="deviceChecked" value="deviceChecked" />'},
						{name:'Pre-Existing Conditions',lastSuccessfulUpdate:'${empty command.preExistingConditionsLastSuccessfullyUpdated ? "never":command.preExistingConditionsLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.preExistingConditionsLastUpdated ? "never":command.preExistingConditionsLastUpdatedStr} <div> <img class="indicator" id="conditionIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div>',select:'<input type="checkbox" name="conditionChecked" id="conditionChecked" value="conditionChecked" />'},
						{name:'Therapies',lastSuccessfulUpdate:'${empty command.therapiesLastSuccessfullyUpdated ? "never":command.therapiesLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.therapiesLastUpdated ? "never":command.therapiesLastUpdatedStr} <div> <img class="indicator" id="therapyIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div>',select:'<input type="checkbox" name="therapyChecked" id="therapyChecked" value="therapyChecked" />'},
						{name:'Agent Dose Units of Measure',lastSuccessfulUpdate:'${empty command.agentDoseMeasureLastSuccessfullyUpdated ? "never":command.agentDoseMeasureLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.agentDoseMeasureLastUpdated ? "never":command.agentDoseMeasureLastUpdatedStr} <div> <img class="indicator" id="agentDUOMIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div>',select:'<input type="checkbox" name="agentDUOMChecked" id="agentDUOMChecked" value="agentDUOMChecked" />'},
						{name:'Lab',lastSuccessfulUpdate:'${empty command.labLastSuccessfullyUpdated ? "never":command.labLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.labLastUpdated ? "never":command.labLastUpdatedStr}  <div> <img class="indicator" id="labIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div> </div>',select:'<input type="checkbox" name="labChecked" id="labChecked" value="labChecked"/>'},
						{name:'Agents',lastSuccessfulUpdate:'${empty command.agentsLastSuccessfullyUpdated ? "never":command.agentsLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.agentsLastUpdated ? "never":command.agentsLastUpdatedStr} <div> <img class="indicator" id="agentIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div> </div>',select:'<input type="checkbox" name="agentsChecked" id="agentChecked" value="agentChecked" />'},
						{name:'ASAEL',lastSuccessfulUpdate:'${empty command.asaelLastSuccessfullyUpdated ? "never":command.asaelLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.asaelLastUpdated ? "never":command.asaelLastUpdatedStr}  <div> <img class="indicator" id="asaelIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div>',select:'<input type="checkbox" name="asaelChecked" id="asaelChecked" value="asaelChecked" />'},
						{name:'Organizations',lastSuccessfulUpdate:'${empty command.organizationsLastSuccessfullyUpdated ? "never":command.organizationsLastSuccessfullyUpdatedStr}',lastAttemptedUpdate:'${empty command.organizationsLastUpdated ? "never":command.organizationsLastUpdatedStr} <div> <img class="indicator" id="organizationIndicator" src="<c:url value="/images/indicator.white.gif"/>?${requestScope.webCacheId}" alt="activity indicator"/> </div> </div>',select:'<input type="checkbox" name="organizationChecked" id="organizationChecked" value="organizationsChecked"/>'}];
