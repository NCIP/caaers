    ...
    <chrome:body title="${flow.name}: ${tab.longTitle}">
		...
		<c:if test="${not empty aesummary}">
			...
			<div class="pane summary" id="reporter-summary">
                  <div class="row">
                      ...
                      <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${aesummary['Participant']}" /> </div>
                  </div>
                  <div class="row">
                      <div class="summarylabel" style="width:7em;"><caaers:message code="LBL_Study" /></div>
                      <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${aesummary['Study']}" /></div>
                  </div>
                  <div class="row">
                      <div class="summarylabel" style="width:7em;"><caaers:message code="LBL_CourseCycle" /></div>
                      <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${aesummary['Course']}" /></div>
                  </div>
                  <c:if test="${aesummary['Report Name'] != null}">
                      <div class="row">
                          <div class="summarylabel" style="width:7em;"><caaers:message code="LBL_Report" /></div>
                          <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${aesummary['Report Name'] }" /></div>
                      </div>
                  </c:if>
		...
		<c:if test="${not empty routineAeSummary}">
			<div class="pane summary" id="ae-summary">
			  <div class="row">
			    <div class="summarylabel" style="width:7em;"><caaers:message code="LBL_Subject" /></div>
			    <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${routineAeSummary['Participant']}"/></div>
			  </div>
			  <div class="row">
			    <div class="summarylabel" style="width:7em;"><caaers:message code="LBL_Study" /></div>
			    <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${routineAeSummary['Study']}" /></div>
			  </div>
			  <div class="row">
			    <div class="summarylabel" style="width:7em;"><caaers:message code="LBL_CourseCycle" /></div>
			    <div class="summaryvalue shorty" style="margin-left:8em;"><c:out escapeXml="true" value="${routineAeSummary['Course']}"/></div>
			  </div>
			</div>
		</c:if>
