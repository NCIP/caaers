...
jQuery(function ($) {
    ...
    jQuery("document").ready(function () {
        var th = new ieTextAreaHack(jQuery("#_ta"));
...
<body>
<h2>The Hacked IE Textarea Object Plugin(beta)</h2>
<table width="100%">
    <tr>
        <td valign="top">
            <textarea style="width:300px;height:100px;" id="_ta">hello, this is supposed to work, LOL</textarea><input type="button" value="test" onclick="test()"/>
            <br/>
            keycode:<br/>
            <span class="result" id="result"></span><br/>
        </td>
        <td valign="top">
            Update Position By:<span class="result" id="result5"></span><br/>
            Original Caret Start Position:<span class="result" id="result13"></span><br/>
            Original Caret End Position:<span class="result" id="result16"></span><br/>
            Calculated Caret Position:<span class="result" id="CalculatedCaret"></span><br/>
            max position:<span class="result" id="result7"></span><br/>
            keydown:<span class="result" id="result3"></span><br/>
            line array:<span class="result" id="result4"></span><br/>
            line Number:<span class="result" id="result10"></span><br/>
            Left Position:<span class="result" id="result11"></span><br/>
            Last Position:<span class="result" id="result6"></span><br/>
            Trailing Enter:<span class="result" id="result8"></span><br/>
            Touch the Trailing Enter:<span class="result" id="result9"></span><br/>
            Selected text: "<span class="result" id="result14"></span>"<br/>
            Selected text length: <span class="result" id="result17"></span><br/>
            Selection: <span class="result" id="result15"></span><br/>
        </td>
    </tr>
</table>
</body>
