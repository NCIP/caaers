...
@WebService(endpointInterface = "gov.nih.nci.cabig.caaers.api.AdverseEventManagementService", serviceName = "AdverseEventManagementService", targetNamespace = "http://webservice.caaers.cabig.nci.nih.gov")
