...
import gov.nih.nci.ess.ae.service.query.common.QueryConstants;
import gov.nih.nci.ess.ae.service.query.stubs.QueryResourceProperties;
 ...
 * 
 */
public class QueryResourceHome extends ResourceHomeImpl {
	...
	public ResourceKey createResource() throws Exception {
		...
		QueryResource resource = (QueryResource) createNewInstance();
		// Create the resource properties bean so that the resource can use it to hold the  resource property values
		QueryResourceProperties props = new QueryResourceProperties();
        ...
        resource.initialize(props, QueryConstants.RESOURCE_PROPERTY_SET, id);
 	...
 	*/
	public gov.nih.nci.ess.ae.service.query.stubs.types.QueryReference getResourceReference(ResourceKey key) throws Exception {
		MessageContext ctx = MessageContext.getCurrentContext();
		String transportURL = (String) ctx.getProperty(org.apache.axis.MessageContext.TRANS_URL);
		transportURL = transportURL.substring(0,transportURL.lastIndexOf('/') +1 );
		transportURL += "Query";
		EndpointReferenceType epr = AddressingUtils.createEndpointReference(transportURL,key);
		gov.nih.nci.ess.ae.service.query.stubs.types.QueryReference ref = new gov.nih.nci.ess.ae.service.query.stubs.types.QueryReference();
 	...
 	*/	
	public QueryResource getResource(ResourceKey key) throws ResourceException {
		QueryResource thisResource = (QueryResource)find(key);
		return thisResource;
	}
     ...
     */
    public QueryResource getAddressedResource() throws Exception {
        QueryResource thisResource;
        thisResource = (QueryResource) ResourceContext.getResourceContext().getResource();
        return thisResource;
    }
