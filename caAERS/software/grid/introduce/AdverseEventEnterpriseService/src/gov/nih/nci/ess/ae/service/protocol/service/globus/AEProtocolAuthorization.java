 ...
 * 
 */
public class AEProtocolAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.ae.ess.nci.nih.gov/AdverseEventEnterpriseService/AEProtocol";
	
	Map authorizationClassMap = new HashMap();
	
	
	public AEProtocolAuthorization() {
	}
	...
	public void authorizeUpdateCodingTerminologyForStudy(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("updateCodingTerminologyForStudy")){
			authorizeUpdateCodingTerminologyForStudy(peerSubject, context, operation);
			return true;
