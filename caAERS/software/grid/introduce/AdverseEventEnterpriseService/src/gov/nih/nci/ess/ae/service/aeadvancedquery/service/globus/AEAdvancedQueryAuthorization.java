 ...
 * 
 */
public class AEAdvancedQueryAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.ae.ess.nci.nih.gov/AdverseEventEnterpriseService/AEAdvancedQuery";
	
	Map authorizationClassMap = new HashMap();
	
	
	public AEAdvancedQueryAuthorization() {
	}
	...
	public void authorizeQueryAdverseEvents(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("queryAdverseEvents")){
			authorizeQueryAdverseEvents(peerSubject, context, operation);
			return true;
