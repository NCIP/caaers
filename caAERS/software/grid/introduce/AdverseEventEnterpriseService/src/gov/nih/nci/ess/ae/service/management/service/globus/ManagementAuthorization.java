 ...
 * 
 */
public class ManagementAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.ae.ess.nci.nih.gov/AdverseEventEnterpriseService/Management";
	
	Map authorizationClassMap = new HashMap();
	
	
	public ManagementAuthorization() {
	}
	...
	public void authorizeInitiateAdverseEvent(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeUpdateAdverseEvent(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeDeactivateAdverseEvent(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("initiateAdverseEvent")){
			authorizeInitiateAdverseEvent(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("updateAdverseEvent")){
			authorizeUpdateAdverseEvent(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("deactivateAdverseEvent")){
			authorizeDeactivateAdverseEvent(peerSubject, context, operation);
			return true;
