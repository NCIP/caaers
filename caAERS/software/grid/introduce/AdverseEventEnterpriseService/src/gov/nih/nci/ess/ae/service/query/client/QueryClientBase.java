 ...
 */
public abstract class QueryClientBase extends ServiceSecurityClient {	
	protected QueryPortType portType;
	...
	public QueryClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public QueryClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected QueryPortType createPortType() throws RemoteException {
		...
		QueryPortType port = null;
		try {
			port = locator.getQueryPortTypePort(getEndpointReference());
		} catch (Exception e) {
