...
import gov.nih.nci.ess.ae.common.AdverseEventEnterpriseServiceConstants;
import gov.nih.nci.ess.ae.stubs.AdverseEventEnterpriseServiceResourceProperties;
 ...
 * 
 */
public abstract class AdverseEventEnterpriseServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(AdverseEventEnterpriseServiceResourceBase.class);

	private AdverseEventEnterpriseServiceResourceConfiguration configuration;
    ...
    public AdverseEventEnterpriseServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((AdverseEventEnterpriseServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(AdverseEventEnterpriseServiceConstants.SERVICEMETADATA);
	...
	public AdverseEventEnterpriseServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (AdverseEventEnterpriseServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((AdverseEventEnterpriseServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
