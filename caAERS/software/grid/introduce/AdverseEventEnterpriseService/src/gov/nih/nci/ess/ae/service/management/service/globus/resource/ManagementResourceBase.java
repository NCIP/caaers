 ...
 * 
 */
public abstract class ManagementResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(ManagementResourceBase.class);

	private ManagementResourceConfiguration configuration;
	...
	public ManagementResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (ManagementResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
