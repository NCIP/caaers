 ...
 * 
 */
public class QueryAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.ae.ess.nci.nih.gov/AdverseEventEnterpriseService/Query";
	...
	public void authorizeFindAdverseEvents(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetAdverseEventData(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("findAdverseEvents")){
			authorizeFindAdverseEvents(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getAdverseEventData")){
			authorizeGetAdverseEventData(peerSubject, context, operation);
			return true;
