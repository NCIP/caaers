 ...
 * 
 */
public abstract class AEProtocolResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(AEProtocolResourceBase.class);

	private AEProtocolResourceConfiguration configuration;
	...
	public AEProtocolResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (AEProtocolResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
