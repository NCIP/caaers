 ...
 * 
 */
public class AdverseEventEnterpriseServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.ae.ess.nci.nih.gov/AdverseEventEnterpriseService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public AdverseEventEnterpriseServiceAuthorization() {
	}
