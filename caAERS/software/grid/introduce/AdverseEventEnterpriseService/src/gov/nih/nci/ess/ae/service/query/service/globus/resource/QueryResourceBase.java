 ...
 * 
 */
public abstract class QueryResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(QueryResourceBase.class);

	private QueryResourceConfiguration configuration;
	...
	public QueryResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (QueryResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
