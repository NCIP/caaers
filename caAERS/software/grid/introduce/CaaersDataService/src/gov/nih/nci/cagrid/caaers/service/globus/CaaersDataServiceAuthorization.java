 ...
 * 
 */
public class CaaersDataServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://caaers.cagrid.nci.nih.gov/CaaersDataService";
	
	
	public CaaersDataServiceAuthorization() {
	}
