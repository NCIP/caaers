 ...
 * 
 */
public class SafetyReportingEnterpriseServiceAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.safetyreporting.ess.nci.nih.gov/SafetyReportingEnterpriseService";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SafetyReportingEnterpriseServiceAuthorization() {
	}
