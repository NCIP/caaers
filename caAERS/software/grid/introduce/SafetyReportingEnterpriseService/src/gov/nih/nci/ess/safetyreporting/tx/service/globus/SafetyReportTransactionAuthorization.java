...
public class SafetyReportTransactionAuthorization implements PDP {
	...
	public static final String SERVICE_NAMESPACE = "http://safetyreporting.ess.nci.nih.gov/SafetyReportingEnterpriseService/SafetyReportTransaction";
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("amendSafetyReport")){
