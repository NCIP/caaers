...
import gov.nih.nci.ess.safetyreporting.rdquery.common.SafetyReportDefinitionQueryConstants;
import gov.nih.nci.ess.safetyreporting.rdquery.stubs.SafetyReportDefinitionQueryResourceProperties;
...
public class SafetyReportDefinitionQueryResourceHome extends ResourceHomeImpl {
 	...
 	*/
	public gov.nih.nci.ess.safetyreporting.rdquery.stubs.types.SafetyReportDefinitionQueryReference getResourceReference(ResourceKey key) throws Exception {
		...
		gov.nih.nci.ess.safetyreporting.rdquery.stubs.types.SafetyReportDefinitionQueryReference ref = new gov.nih.nci.ess.safetyreporting.rdquery.stubs.types.SafetyReportDefinitionQueryReference();
