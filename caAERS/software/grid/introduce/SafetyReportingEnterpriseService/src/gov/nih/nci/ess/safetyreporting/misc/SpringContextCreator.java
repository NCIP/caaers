...
import gov.nih.nci.ess.safetyreporting.common.SafetyReportingEnterpriseServiceI;
			...
			if (SpringContextHolder.getApplicationContext() == null) {
				ctx = new ClassPathXmlApplicationContext(
						ContainerConfig
								.getConfig()
								.getOption(
										SafetyReportingEnterpriseServiceI.SPRING_CLASSPATH_EXPRESSION,
										SafetyReportingEnterpriseServiceI.DEFAULT_SPRING_CLASSPATH_EXPRESSION));
