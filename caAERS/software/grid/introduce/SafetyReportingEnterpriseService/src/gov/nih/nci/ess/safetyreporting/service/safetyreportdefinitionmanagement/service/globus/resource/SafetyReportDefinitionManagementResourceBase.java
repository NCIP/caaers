 ...
 * 
 */
public abstract class SafetyReportDefinitionManagementResourceBase extends ReflectionResource implements Resource
                                                  ,SecureResource
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(SafetyReportDefinitionManagementResourceBase.class);

	private SafetyReportDefinitionManagementResourceConfiguration configuration;
    ...
    public SafetyReportDefinitionManagementResourceBase() {
    }
	...
	public SafetyReportDefinitionManagementResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (SafetyReportDefinitionManagementResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
