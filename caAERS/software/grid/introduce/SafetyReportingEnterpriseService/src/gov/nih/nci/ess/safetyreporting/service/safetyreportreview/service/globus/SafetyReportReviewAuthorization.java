 ...
 * 
 */
public class SafetyReportReviewAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.safetyreporting.ess.nci.nih.gov/SafetyReportingEnterpriseService/SafetyReportReview";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SafetyReportReviewAuthorization() {
	}
