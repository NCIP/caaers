 ...
 * 
 */
public class SafetyReportAdvancedQueryAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://safetyreporting.ess.nci.nih.gov/SafetyReportingEnterpriseService/SafetyReportAdvancedQuery";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SafetyReportAdvancedQueryAuthorization() {
	}
	...
	public void authorizeGetSafetyReportSummaryData(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("getSafetyReportSummaryData")){
			authorizeGetSafetyReportSummaryData(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
