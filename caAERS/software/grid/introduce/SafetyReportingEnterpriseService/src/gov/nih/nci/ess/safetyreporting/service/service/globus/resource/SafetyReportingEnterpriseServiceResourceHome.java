 ...
 * 
 */
public class SafetyReportingEnterpriseServiceResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(SafetyReportingEnterpriseServiceResourceHome.class);
    private static final UUIDGen UUIDGEN = UUIDGenFactory.getUUIDGen();

	public Resource createSingleton() {
		logger.info("Creating a single resource.");
		try {
		    SafetyReportingEnterpriseServiceResourceProperties props = new SafetyReportingEnterpriseServiceResourceProperties();
			SafetyReportingEnterpriseServiceResource resource = new SafetyReportingEnterpriseServiceResource();
			if (resource instanceof PersistenceCallback) {
                  ...
                  try{
                    ((PersistenceCallback) resource).load(null);
			          ...
			          resource.initialize(props, SafetyReportingEnterpriseServiceConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
			      }
            } else {
                    resource.initialize(props, SafetyReportingEnterpriseServiceConstants.RESOURCE_PROPERTY_SET, UUIDGEN.nextUUID());
            }
	...
	public Resource find(ResourceKey key) throws ResourceException {
		SafetyReportingEnterpriseServiceResource resource = (SafetyReportingEnterpriseServiceResource) super.find(key);
		return resource;
	}
