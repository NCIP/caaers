 ...
 */
public abstract class SafetyReportManagementClientBase extends ServiceSecurityClient {	
	protected SafetyReportManagementPortType portType;
	...
	public SafetyReportManagementClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public SafetyReportManagementClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
	...
	protected SafetyReportManagementPortType createPortType() throws RemoteException {

		SafetyReportManagementServiceAddressingLocator locator = new SafetyReportManagementServiceAddressingLocator();
		...
		SafetyReportManagementPortType port = null;
		try {
			port = locator.getSafetyReportManagementPortTypePort(getEndpointReference());
		} catch (Exception e) {
