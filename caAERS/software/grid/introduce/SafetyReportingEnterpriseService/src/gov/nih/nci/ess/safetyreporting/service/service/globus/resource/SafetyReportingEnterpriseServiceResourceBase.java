package gov.nih.nci.ess.safetyreporting.service.service.globus.resource;
...
import gov.nih.nci.ess.safetyreporting.service.common.SafetyReportingEnterpriseServiceConstants;
import gov.nih.nci.ess.safetyreporting.service.stubs.SafetyReportingEnterpriseServiceResourceProperties;
import gov.nih.nci.ess.safetyreporting.service.service.SafetyReportingEnterpriseServiceConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class SafetyReportingEnterpriseServiceResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(SafetyReportingEnterpriseServiceResourceBase.class);

	private SafetyReportingEnterpriseServiceResourceConfiguration configuration;
    ...
    public SafetyReportingEnterpriseServiceResourceBase() {
    }
	...
	public gov.nih.nci.cagrid.metadata.ServiceMetadata getServiceMetadata(){
		return ((SafetyReportingEnterpriseServiceResourceProperties) getResourceBean()).getServiceMetadata();
	}
	
	public void setServiceMetadata(gov.nih.nci.cagrid.metadata.ServiceMetadata serviceMetadata ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(SafetyReportingEnterpriseServiceConstants.SERVICEMETADATA);
	...
	public SafetyReportingEnterpriseServiceResourceConfiguration getConfiguration() {
		...
		try {
			...
			this.configuration = (SafetyReportingEnterpriseServiceResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
	...
	private void loadServiceMetadataFromFile() {
      if(getServiceMetadata()==null){
		try {
			...
			((SafetyReportingEnterpriseServiceResourceProperties) this.getResourceBean()).setServiceMetadata((gov.nih.nci.cagrid.metadata.ServiceMetadata) Utils.deserializeDocument(dataFile.getAbsolutePath(),
