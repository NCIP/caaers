...
public class SafetyReportNotificationProviderImpl{
    ...
    impl.createSafetyReportDefinitionNotification(params.getSafetyReportDefinitionNotification().getSafetyReportDefinitionNotification(),params.getReportDefinitionId().getId());
    return boxedResult;
  }
    ...
    impl.updateSafetyReportDefinitionNotification(params.getSafetyReportDefinitionNotification().getSafetyReportDefinitionNotification());
    return boxedResult;
  }
    ...
    impl.deactivateSafetyReportDefinitionNotification(params.getNotificationId().getId(),params.getReasonForDeactivation().getST());
    return boxedResult;
  }
