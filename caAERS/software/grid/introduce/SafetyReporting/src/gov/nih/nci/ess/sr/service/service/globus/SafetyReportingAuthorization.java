 ...
 * 
 */
public class SafetyReportingAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.sr.ess.nci.nih.gov/SafetyReporting";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SafetyReportingAuthorization() {
	}
