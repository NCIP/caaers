 ...
 * 
 */
public class SafetyReportRulesEvaluationAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://service.sr.ess.nci.nih.gov/SafetyReporting/SafetyReportRulesEvaluation";
	
	Map authorizationClassMap = new HashMap();
	
	
	public SafetyReportRulesEvaluationAuthorization() {
	}
	...
	public void authorizeEvaluateAgainstSafetyReportingRules(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getServiceSecurityMetadata")){
			...
			return true;
		} else if(operation.getLocalPart().equals("evaluateAgainstSafetyReportingRules")){
			authorizeEvaluateAgainstSafetyReportingRules(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
