...
public class ExpeditedToSafetyReportConverterImpl implements ExpeditedToSafetyReportConverter {
	...
	/* (non-Javadoc)
	 * @see gov.nih.nci.ess.sr.ExpeditedToSafetyReportConverter#convertExpeditedAdverseEventReport(gov.nih.nci.cabig.caaers.domain.ExpeditedAdverseEventReport)
	 */
