...
public class SafetyMonitoringServiceImplUnitTest extends AbstractTestCase {
	...
	private void setupStudy(){
		...
		aeList.add(new Object[]{ae1a, exp, tac1});
		aeList.add(new Object[]{ae1b, exp, tac1});
		aeList.add(new Object[]{ae1c, exp, tac1});
		aeList.add(new Object[]{ae2, exp, tac1});
		aeList.add(new Object[]{ae3, exp, tac1});
		aeList.add(new Object[]{ae4, exp, tac1});
		aeList.add(new Object[]{ae5, exp, tac1});
		...
		aeList.add(new Object[]{ae1, exp, tac2});
		aeList.add(new Object[]{ae2, exp, tac2});
		aeList.add(new Object[]{ae3, exp, tac2});
		aeList.add(new Object[]{ae4a, exp, tac2});
		aeList.add(new Object[]{ae4b, exp, tac2});
		aeList.add(new Object[]{ae5a, exp, tac2});
		aeList.add(new Object[]{ae5b, exp, tac2});
