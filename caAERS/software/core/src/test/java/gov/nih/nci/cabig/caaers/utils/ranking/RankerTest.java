...
public class RankerTest extends TestCase {
    ...
    public void testRank() throws Exception {
        ...
        assertEquals(865, ranker.rank("This sentence has biju joseph's name mentioned biju joseph says again biju joseph and cannot say biju jose", "biju Joseph", serializer).getRank());
        ...
        assertEquals(999, ranker.rank("(5876) Test Study", "5876", serializer).getRank());
