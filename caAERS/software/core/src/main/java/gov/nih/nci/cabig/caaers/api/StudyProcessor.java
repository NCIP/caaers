...
public interface StudyProcessor {
	 ...
	 */
	@WebMethod
	public gov.nih.nci.cabig.caaers.webservice.CaaersServiceResponse createStudy(@WebParam(name="Studies",
	 ...
	 */
	@WebMethod
	public gov.nih.nci.cabig.caaers.webservice.CaaersServiceResponse updateStudy(@WebParam(name="Studies",
            targetNamespace="http://webservice.caaers.cabig.nci.nih.gov") Studies xmlStudies);
