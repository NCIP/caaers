 ...
 * 
 */
public class LocalSessionFactoryBeanWithOracle11Support extends
	...
	private static final Logger log = Logger
			.getLogger(LocalSessionFactoryBeanWithOracle11Support.class);

	/*
	 * (non-Javadoc)
	 * 
	 * @see
	 * org.springframework.orm.hibernate3.AbstractSessionFactoryBean#setDataSource
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.springframework.orm.hibernate3.LocalSessionFactoryBean#
	 * setHibernateProperties(java.util.Properties)
	 */
	@Override
	public void setHibernateProperties(Properties hibernateProperties) {
		if (driverClassName != null
			...
			hibernateProperties.setProperty(HIBERNATE_DIALECT,
