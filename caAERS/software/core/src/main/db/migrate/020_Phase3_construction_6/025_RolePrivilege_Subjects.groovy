class RolePrivilegeImport extends edu.northwestern.bioinformatics.bering.Migration {
    ...
    void up() {
      ...
      insert('role_privilege', [ version: '0',role_name : 'registar',object_id : 'gov.nih.nci.cabig.caaers.domain.StudyParticipantAssignment',privilege :'CREATE']);
      insert('role_privilege', [ version: '0',role_name : 'registar',object_id : 'gov.nih.nci.cabig.caaers.domain.StudyParticipantAssignment',privilege :'READ']);
