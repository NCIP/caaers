...
delete from csm_group where group_name like 'gov.nih.nci.cabig.caaers%';
...
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES (csm_group_group_id_seq.nextval,	'expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		-1);
INSERT INTO csm_group(group_id, group_name, group_desc, application_id) VALUES (csm_group_group_id_seq.nextval,	'adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		-1);
...
INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES (csm_role_role_id_seq.nextval,	'expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow',		-1, 1);
INSERT INTO csm_privilege(privilege_id, privilege_name, privilege_description) VALUES (csm_privilege_privilege_id_seq.nextval,	'expedited_report_reviewer',	'Read-only: reviews, provides comments, and routes expedited reports through the review workflow');
INSERT INTO csm_role_privilege(role_privilege_id, role_id, privilege_id) VALUES (csm_role_priv_role_privile_seq.nextval,csm_role_role_id_seq.currval,csm_privilege_privilege_id_seq.currval);

INSERT INTO csm_role(role_id, role_name, role_description, application_id, active_flag) VALUES (csm_role_role_id_seq.nextval,	'adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow',		-1, 1);
INSERT INTO csm_privilege(privilege_id, privilege_name, privilege_description) VALUES (csm_privilege_privilege_id_seq.nextval,	'adverse_event_study_data_reviewer',	'Read-only: reviews, provides comments, and adverse event data through a review workflow');
INSERT INTO csm_role_privilege(role_privilege_id, role_id, privilege_id) VALUES (csm_role_priv_role_privile_seq.nextval,csm_role_role_id_seq.currval,csm_privilege_privilege_id_seq.currval);
