...
INSERT INTO wf_transition_configs(id,transition_name, task_config_id) VALUES (seq_wf_transition_configs_id.nextval,'Submit to Central Office Report Reviewer',SEQ_TASK_CONFIGURATION_ID.currval);
INSERT INTO wf_transition_owners(id,"name", user_role_id, transition_config_id,dtype) VALUES (seq_wf_transition_owners_id.nextval,'Central Office SAE Coordinator',9,currval('wf_transition_configs_id_seq'),'r');
...
'The task "Provide Additional Information To Medical Monitor" is assigned to you. Please use the link ${EXPEDITED_REPORT_LINK} to access the report.','Submit Report To Medical Monitor');
INSERT INTO wf_assignees(id,"name", user_role_id,task_config_id, dtype)    VALUES (SEQ_WF_ASSIGNEES_ID.nextval,'Central Office SAE Coordinator',9,SEQ_TASK_CONFIGURATION_ID.currval,'r');
...
'The task "Compile Comments" is assigned to you. Please use the link ${EXPEDITED_REPORT_LINK} to access the report.','Submit Report To Medical Monitor');
INSERT INTO wf_assignees(id,"name", user_role_id,task_config_id, dtype)    VALUES (SEQ_WF_ASSIGNEES_ID.nextval,'Central Office SAE Coordinator',9,SEQ_TASK_CONFIGURATION_ID.currval,'r');
...
'The task "Finalize Report and Submit" is assigned to you. Please use the link ${EXPEDITED_REPORT_LINK} to access the report.','Submit Report To Medical Monitor');
