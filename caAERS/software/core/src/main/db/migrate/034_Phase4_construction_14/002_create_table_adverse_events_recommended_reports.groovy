class CreateTableAdverseEventRecommendedReports extends edu.northwestern.bioinformatics.bering.Migration {
     void up() {
        ...
        //fk
         ...
         execute("alter table ae_recom_reports add constraint fk_ae_recom_rpts_tmplt_id FOREIGN KEY(report_definition_id) references REPORT_CALENDAR_TEMPLATES(id)");
    }
