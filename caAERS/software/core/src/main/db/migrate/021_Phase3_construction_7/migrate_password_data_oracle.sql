...
select seq_caaers_users_id.nextval,login_id,salt,token,token_time,password_last_set,last_login,num_failed_logins
from research_staffs where login_id is not null;

insert into caaers_users (id,login_name,salt,token,token_time,password_last_set,last_login,num_failed_logins) 
select seq_caaers_users_id.nextval,login_id,salt,token,token_time,password_last_set,last_login,num_failed_logins
from investigators where login_id is not null and allowed_to_login = 1;
