...
config. BgColor			= '#EEEEFF'	// Background colour (HTML colour value, in quotes)
config. BgImg			= '105'		// Path to background image, none if empty string ''
config. BorderColor		= '#8682CC'
...
config. CloseBtnColors	= ['#FF0000', '#FFFFFF', '#990000', '#FFFFFF']	// [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colours
