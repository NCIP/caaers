...
<div class="row" id="priorTherapies[${parentIndex}].priorTherapyAgents[${index}]-row" >
        <div class="value">
            <input size="50" type="text" id="priorTherapies[${parentIndex}].priorTherapyAgents[${index}].chemoAgent-input"  class="autocomplete"/>
            <tags:indicator id="priorTherapies[${parentIndex}].priorTherapyAgents[${index}].chemoAgent-indicator"/>

            <div id="priorTherapies[${parentIndex}].priorTherapyAgents[${index}].chemoAgent-choices" class="autocomplete" style="display: none"></div>
            ...
            <form:hidden path="priorTherapies[${parentIndex}].priorTherapyAgents[${index}].chemoAgent"/>

        </div>
</div>
<script>
AE.createStandardAutocompleter('priorTherapies[${parentIndex}].priorTherapyAgents[${index}].chemoAgent', 
