...
<div id="ss-section-0" class="row ss-section" style="${style}">
    ...
    <table width="100%" class="tablecontent" valign="top">
        ...
        <c:forEach var="si" items="${command.study.studyOrganizations[index].studyInvestigators}" varStatus="status">
        ...
        <c:if test="${fn:length(command.study.studyOrganizations[index].studyInvestigators) lt 1}">
