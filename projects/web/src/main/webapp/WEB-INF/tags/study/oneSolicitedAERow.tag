...
<%@attribute name="eachRow" required="true" type="java.util.LinkedList"%>
    			<tr id="tr-${eachRow[0]}" class="data" align="center">
    			   ...
    			   <c:choose>
    				...
    				<td><input  class="ck1" id="ck1-${eachRow[0]}" name="epoch[0]" value="${eachRow[0]}" type="checkbox" <c:out value="${epoch1checked}" />/></td>
    				<td><input   class="ck2" id="ck2-${eachRow[0]}" name="epoch[1]" value="${eachRow[0]}" type="checkbox" <c:out value="${epoch2checked}" />/></td>
    				<td><input   class="ck3" id="ck3-${eachRow[0]}" name="epoch[2]" value="${eachRow[0]}" type="checkbox" <c:out value="${epoch3checked}" />/></td>
