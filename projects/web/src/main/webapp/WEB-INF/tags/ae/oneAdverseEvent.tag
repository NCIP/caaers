					...
					<%@attribute name="style"%>
						...
						<chrome:division title="${title}" id="ae-section-${index}" cssClass="ae-section" style="${style}">
							<div id="aeReport.adverseEvents[${index}].ctc-details" class="ctc-details">
								...
								<div class="row">
									<div class="label">
										<label for="aeReport.adverseEvents[${index}].ctc-category">CTC category</label>
									</div>
									<div class="value">
								...
								<div id="table${index}-outer" style="position: absolute; display: none;width:400px; left: 520px; ">
									<table width="100%" class="eXtremeTable" frame="border" border-color="blue" bgcolor="white">
										<tbody>
											<tr class="titleRow">
												<td align="left" class="title">Select CTC term:</td>
												<td width="20px">
													<a href="javascript:hideShowAllTable('table${index}-outer')">
								...
								<tags:renderRow field="${fieldGroups[ctcOtherGroup].fields[0]}" style="display: none">
									<jsp:attribute name="label">
										<label>
											<input id="select-meddra-${index}" name="meddraOrVerbatim${index}" type="radio"/>${fieldGroups[ctcOtherGroup].fields[0].displayName} 
										</label>
									</jsp:attribute>
								</tags:renderRow>
								<tags:renderRow field="${fieldGroups[ctcOtherGroup].fields[1]}" style="display: none">
									<jsp:attribute name="label">
										<label>
											<input id="select-other-${index}" name="meddraOrVerbatim${index}" type="radio"/>${fieldGroups[ctcOtherGroup].fields[1].displayName} 
										</label>
									</jsp:attribute>
								</tags:renderRow>
							</div>
