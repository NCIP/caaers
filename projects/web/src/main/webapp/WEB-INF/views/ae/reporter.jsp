...
<html>
<head>
    <title>${tab.longTitle}<a href=  "/caaers/NetHelp/caaersSource_full.htm#section11reporterinformation.htm" target="_blank"><img align="right" src="/caaers/images/book.gif" border="0" alt="HelpIndex" title="Help Index"></a></title>
