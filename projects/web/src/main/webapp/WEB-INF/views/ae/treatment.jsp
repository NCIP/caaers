...
<html>
<head>
    <title>${tab.longTitle}<a href="/caaers/Help/caaersSource_full.htm#section5treatmentinformation.htm" target="_blank"><img align="right" src="/caaers/images/book.gif" border="0" alt="HelpIndex" title="Help Index"></a></title>
