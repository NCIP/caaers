...
<style type="text/css">
        ...
        div.row div.value { margin-left: 11em; }
        input { width:8em; }
</style>
...
<div class="row" style="float:right;">
	<input class='ibutton' type='button' onclick="buildTable('assembler'); $('bigSearch').show();" value='Search'  title='Search Routine Report'/>
