						...
						<%@taglib prefix="rd" tagdir="/WEB-INF/tags/report" %>
							<html>
								<head>
									...
									<style type="text/css">div.row div.label { width: 13em; } div.row div.value { margin-left: 14em; }</style>
								</head>
								<body>
									<tags:tabForm tab="${tab}" flow="${flow}" >
										<jsp:attribute name="instructions">Select the fields of adverse event entry screen which are to be made mandatory, when 
											<b>${command.reportDefinition.name}</b>report definition is associated to a adverse event report. 
											<i>
												<br/>
												<b>TODO:</b>need a better instruction...
											</i>
											<br></jsp:attribute>
