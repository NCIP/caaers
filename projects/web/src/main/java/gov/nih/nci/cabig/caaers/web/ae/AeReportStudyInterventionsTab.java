 ...
 */
public class AeReportStudyInterventionsTab extends ExpeditedAdverseEventReportTab{
	
	public AeReportStudyInterventionsTab() {
		super("Study Interventions", "Study Interventions", "ae/aeReportStudyInterventions");
