...
public class DateValueEditor extends PropertyEditorSupport{
	...
	public void setAsText(String text) throws IllegalArgumentException {
		...
		if(size != 3)throw new IllegalArgumentException("Unknown format, expected format is 'mm/dd/yyyy'");
		...
		try{
			...
			throw new IllegalArgumentException("Unknown format, unable to parse the date values, expected format is 'mm/dd/yyyy'", e);
		}
		setValue(dateValue);
	}
