...
/**
 * Parses the given privilege as comma-separated list of role
 * names. Checks
 * if Authentication has at least one GrantedAuthority with one of the
 * given role names. The objectId is ignored.
 * 
