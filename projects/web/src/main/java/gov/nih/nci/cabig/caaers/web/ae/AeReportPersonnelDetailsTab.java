 ...
 */
public class AeReportPersonnelDetailsTab extends ExpeditedAdverseEventReportTab{
	
	public AeReportPersonnelDetailsTab() {
		super("Personnel Details", "Personnel Details", "ae/aeReportPersonnelDetails");
