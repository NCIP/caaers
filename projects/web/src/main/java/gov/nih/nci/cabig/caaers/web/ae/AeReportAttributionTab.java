 ...
 */
public class AeReportAttributionTab extends ExpeditedAdverseEventReportTab{
	
	public AeReportAttributionTab() {
		super("Attribution", "Attribution", "ae/aeReportAttribution");
