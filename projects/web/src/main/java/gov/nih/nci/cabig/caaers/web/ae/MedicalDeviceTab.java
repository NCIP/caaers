    ...
    protected void createFieldGroups(AeInputFieldCreator creator,
        ...
        creator
                .createRepeatingFieldGroup("medicalDevice", "medicalDevices",
                        ...
                        InputFieldFactory.createPastDateField("expirationDate",
                        ...
                        InputFieldFactory.createPastDateField("implantedDate",
                                "If implanted, enter a date", false),
                        InputFieldFactory.createPastDateField("explantedDate",
                        ...
                        InputFieldFactory.createPastDateField("returnedDate",
                                "Returned date", false));
    }
