 ...
 */
public class AeReportPatientDetailsTab extends ExpeditedAdverseEventReportTab{
	
	public AeReportPatientDetailsTab() {
		super("Patient Details", "Patient Details", "ae/aeReportPatientDetails");
