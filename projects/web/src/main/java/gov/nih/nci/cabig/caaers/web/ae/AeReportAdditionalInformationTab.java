 ...
 */
public class AeReportAdditionalInformationTab extends ExpeditedAdverseEventReportTab{
	
	public AeReportAdditionalInformationTab() {
		super("Additional Information", "Additional Information", "ae/aeReportAdditionalInformation");
