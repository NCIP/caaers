...
//        if (command.getStudyParticipantAssignment() == null || command.getStudyParticipantAssignment().getStudySubjectIdentifier() == null
//                || command.getStudyParticipantAssignment().getStudySubjectIdentifier().trim().equalsIgnoreCase(""))
//            errors.rejectValue(STUDY_SUBJECT_IDENTIFIER_FIELD, "REQUIRED", "Study subject assigned identifnot selected");
//    }
