 ...
 * @author Biju Joseph <p/> Refactored and fixed issue -8978
 */
public class AssignParticipantStudyController extends
                AbstractTabbedFlowFormController<AssignParticipantStudyCommand> {
    ...
    protected ModelAndView processFinish(HttpServletRequest request, HttpServletResponse response,
        ...
        studyParticipantAssignment.setParticipant(assignParticipantStudyCommand.getParticipants()
                        .get(0));
        studyParticipantAssignment.setStudySite(assignParticipantStudyCommand.getStudySites()
                        .get(0));
        studyParticipantAssignment.setStudySubjectIdentifier(assignParticipantStudyCommand
