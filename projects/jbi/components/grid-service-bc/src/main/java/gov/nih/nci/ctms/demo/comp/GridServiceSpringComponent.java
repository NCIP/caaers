 ...
 *                  description="AuthSvc component"
 */
public class GridServiceSpringComponent extends BaseComponent {

    private GridServiceEndpoint[] endpoints;

    /**
     * @return Returns the endpoints.
     */
    public GridServiceEndpoint[] getEndpoints() {
        return endpoints;
    }
     ...
     */
    public void setEndpoints(GridServiceEndpoint[] endpoints) {
     ...
     * @author gnodet
     */
    public class LifeCycle extends GridServiceLifeCycle {

        protected ServiceUnit su;
        
        public LifeCycle() {
            super(GridServiceSpringComponent.this);
        }
        ...
        protected void doInit() throws Exception {
            ...
            su.setComponent(GridServiceSpringComponent.this);
