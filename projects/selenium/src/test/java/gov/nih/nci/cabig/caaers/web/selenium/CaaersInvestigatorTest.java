...
public class CaaersInvestigatorTest extends CaaersSeleniumTestCase {
	...
	public void testSearchInvestigator() throws Exception {
		...
		//assertTrue("Search Investigator failed for: " + firstName +" dfsdf "+ lastName,false);
		assertTrue("Search Investigator failed for: " + firstName +" "+ lastName,
				selenium.isTextPresent("regexpi:"+firstName)&& selenium.isTextPresent("regexpi:"+lastName));
	}
}
