...
public class ReportLevelBusinessRulesTest extends BusinessRulesExecutionServiceTest {
	...
	public void testChemo_RadiationStudy_HavingRadiation() throws Exception {
		...
		StudyTherapyType[] therapies = new StudyTherapyType[] { StudyTherapyType.DRUG_ADMINISTRATION, StudyTherapyType.RADIATION};
	...
	*/
	public void testSurgeryRadiationStudy_HavingSurgery() throws Exception {
		...
		Study s = aeReport.getStudy();
		StudyTherapyType[] therapies = new StudyTherapyType[] { StudyTherapyType.RADIATION, StudyTherapyType.SURGERY};
		for(int i = 0; i <  therapies.length; i++ ){
			StudyTherapy st = new StudyTherapy();
			st.setId(i+1);
			st.setStudyTherapyType(therapies[i]);
	...
	*/
	...
	public void testCourseSurgeryRadiationStudy_HavingNoRadiationOrSurgeryOrCourse() throws Exception {
		ExpeditedAdverseEventReport aeReport = createAEReport();
		aeReport.setTreatmentInformation(null);
