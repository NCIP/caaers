...
public class AttributionBusinessRulesTest extends
	...
	public void testInCorrectAttribution() throws Exception {
		...
		assertEquals("Replacment variable should be same", 2, errors.getErrorAt(1).getReplacementVariables()[0]);
	}
	...
	public void testNoAttributionAtAll_OneOutOfTwoAEHasGradeDEATH() throws Exception {
		...
		assertEquals("Replacment variable should be same", 2, errors.getErrorAt(0).getReplacementVariables()[0]);
