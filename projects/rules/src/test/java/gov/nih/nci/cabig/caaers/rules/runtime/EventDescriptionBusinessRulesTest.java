...
public class EventDescriptionBusinessRulesTest extends
	...
	public String getRuleFile() {
		return "event_description_rule_1.xml";
	}
	...
	Rule : 'Removed from Protocol Treatment' must be ‘Yes’ if 'Present Status' is ‘Fatal/Died’ 
