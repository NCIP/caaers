...
public class BusinessRulesExecutionServiceImpl implements BusinessRulesExecutionService{
	...
	public List<Object> fireRules(String bindingURI, List<Object> objects) {
		...
		try {
			...
			throw new RuleSetNotFoundException("Unable to locate rule set at bindingUrl :[" + bindingURI + "]" + e.getMessage(),e);
	...
	private StatelessRuleSession getStatelessRuleSession(final String key,final java.util.Map properties) throws ConfigurationException, RemoteException, RuleSessionCreateException,
		RuleExecutionSetNotFoundException, RuleSessionTypeUnsupportedException{
