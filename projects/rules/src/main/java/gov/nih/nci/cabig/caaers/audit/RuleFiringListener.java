...
public class RuleFiringListener implements AgendaEventListener {
    ...
    public void afterActivationFired(AfterActivationFiredEvent afterActivationFiredEvent,
        ...
        if (afterActivationFiredEvent.getActivation().getRule() != null) {
            logger.logMessage("Rule Name:"
                            + afterActivationFiredEvent.getActivation().getRule().getName());
        } else {
        ...
        // logger.logMessage("Rule
        // Name:"+afterActivationFiredEvent.getActivation().getRule().getName()+"| after Firing the
        // rule"+afterActivationFiredEvent.getActivation().getRule().getPackage().toString());
    }
    ...
    public void beforeActivationFired(BeforeActivationFiredEvent beforeActivationFiredEvent,
        ...
        if (beforeActivationFiredEvent.getActivation().getRule() != null) {
            logger.logMessage("Rule Name:"
                            + beforeActivationFiredEvent.getActivation().getRule().getName());
        } else {
            logger.logMessage("Rule was null");
        }
