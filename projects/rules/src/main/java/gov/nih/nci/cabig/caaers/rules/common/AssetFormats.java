...
/**
 * Keeps track of the different rule formats we support. Each format type corresponds to the dublin
 * core "format" attribute.
 * 
 * This is used both by the UI, to determine what are valid formats, and also on the server. If you
 * are adding new types they need to be registered here.
 * 
