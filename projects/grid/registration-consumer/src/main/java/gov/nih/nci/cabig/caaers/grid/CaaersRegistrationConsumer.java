...
public class CaaersRegistrationConsumer implements RegistrationConsumer{
    ...
    public Registration register(Registration registration) throws RemoteException, InvalidRegistrationException, RegistrationConsumptionException {
        ...
        organization.setGridId(registration.getStudySite().getHealthcareSite(0).getGridId());
        ...
        if (partBean.getIdentifier() != null) {
            ...
            for (IdentifierType identifierType : partBean.getIdentifier()) {
            	...
            	if(identifierType instanceof SystemAssignedIdentifierType){
            		...
            		sysIdentifier.setSystemName(sysIdentifierType.getSystemName());
            		identifier = sysIdentifier;
            	}else{
            		OrganizationAssignedIdentifierType orgIdentifierType = (OrganizationAssignedIdentifierType) identifierType;
