 ...
 * 
 */
public class CreateCandidateAdverseEventServiceAuthorization{
	
	
	public CreateCandidateAdverseEventServiceAuthorization() {
	}
	...
	public static void authorizeProcessMessage() throws RemoteException {
