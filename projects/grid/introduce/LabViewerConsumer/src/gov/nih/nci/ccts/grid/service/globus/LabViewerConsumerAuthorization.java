 ...
 * 
 */
public class LabViewerConsumerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://grid.ccts.nci.nih.gov/LabViewerConsumer";
	
	
	public LabViewerConsumerAuthorization() {
	}
	...
	public static void authorizeLoadLabs() throws RemoteException {
