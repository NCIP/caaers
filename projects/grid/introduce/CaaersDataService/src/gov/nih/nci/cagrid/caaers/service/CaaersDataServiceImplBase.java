...
import gov.nih.nci.cagrid.caaers.service.globus.resource.CaaersDataServiceResource;
 ...
 * 
 */
public abstract class CaaersDataServiceImplBase {
	
	public CaaersDataServiceImplBase() throws RemoteException {
	...
	protected Object getMetadata(QName metadataQName) {
		CaaersDataServiceResource serviceBaseResource = null;
		try {
			serviceBaseResource = (CaaersDataServiceResource) ResourceContext.getResourceContext().getResource();
		} catch (ResourceContextException e) {
			return null;
