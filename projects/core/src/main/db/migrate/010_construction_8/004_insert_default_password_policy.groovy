class InsertDefaultPasswordPolicy extends edu.northwestern.bioinformatics.bering.Migration {
    void up() {
        insert('password_policy', [id: 1, ln_allowed_attempts: 5, ln_lockout_duration: 86400, 
                   ...
                   cn_min_length: 7, cn_cb_min_required: 3, cn_cb_is_upper_case_alphabet: false,
                   cn_cb_is_lower_case_alphabet: true, cn_cb_is_non_alpha_numeric: true,
                   cn_cb_is_base_ten_digit: true, cn_cb_max_substring_length: 3],  primaryKey: false)
    }
