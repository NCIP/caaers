...
void up() {
        ...
        insert('csm_protection_element',[protection_element_id: -6,protection_element_name:"gov.nih.nci.cabig.caaers.domain.Organization.DEFAULT ", object_id: "gov.nih.nci.cabig.caaers.domain.Organization.DEFAULT ",application_id: -1], primaryKey: false);
