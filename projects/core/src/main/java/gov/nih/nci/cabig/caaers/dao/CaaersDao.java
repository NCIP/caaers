...
public abstract class CaaersDao<T extends DomainObject> extends AbstractDomainObjectDao<T> {
	...
	/**
	 * A query builder for use by subclass DAOs. It makes it easy to match a fragment of a name or identifier against multiple properties.
	 * This is intended for use in implementing user-friendly dynamic searches; e.g., autocompleters.
	 * 
	...
	/**
	 * Searches based on an example object. For example, if you want to search for a Participant based on last name:
	 * <ul>
	...
	/**
	 * Detaches the passed-in instance (probably a domain object or a collection of domain objects) from the sesison.
	 * @param o
	 */
