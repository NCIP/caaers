...
public class BaseTenDigitValidator implements PolicyValidator{
	...
	public boolean validate(PasswordPolicy policy, Credential credential) throws ValidationException {
		...
		if(!contains){
			throw new ValidationException("The password should have atleast one numerical character{0-9}");
		}
