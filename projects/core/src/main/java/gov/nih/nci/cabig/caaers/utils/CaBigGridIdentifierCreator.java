...
public class CaBigGridIdentifierCreator implements GridIdentifierCreator{
    public String getGridIdentifier(String identification) {
        throw new UnsupportedOperationException("This class is currently unused.  Uncomment body and resolve dependencies later.");
    }
...
//	 * This code will fail if the application server is running with write permissions set to false.
//	 *
//	 * TODO : Id the big id creator code is not going to change, we will have to read this from a location
