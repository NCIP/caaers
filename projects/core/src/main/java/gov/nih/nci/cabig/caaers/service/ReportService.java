...
public interface ReportService {
    ...
    /**
     * Applies runtime variable replacements, with the values availabe in report. Note: Uses
     * freemarker based text replacements
     */
     ...
     * validate against all the sections defined in {@link ExpeditedReportSection}
     * 
