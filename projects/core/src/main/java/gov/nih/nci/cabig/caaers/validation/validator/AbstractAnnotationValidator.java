...
public abstract class AbstractAnnotationValidator<AnnotationType extends Annotation> implements Validator {
    ...
    public abstract void validateAnnotated(AnnotationType annotation, String fieldName, Object fieldValue);	
	...
	logger.info("Validating " + _annotationClass.getName() + " annotations for: " + obj.getClass());
		...
		try {
			...
			AnnotationType annotation = (AnnotationType) method.getAnnotation(_annotationClass);
			try {
