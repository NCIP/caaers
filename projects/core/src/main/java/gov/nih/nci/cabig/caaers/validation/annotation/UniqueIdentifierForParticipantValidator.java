...
public class UniqueIdentifierForParticipantValidator implements Validator<UniqueIdentifierForParticipant> {
    ...
    public boolean validate(final Object value) {
        ...
        if(other.getValue() != null) participantQuery.filterByIdentifierValueExactMatch(other.getValue());
        if(other.getType() != null) participantQuery.filterByIdentifierTypeExactMatch(other.getType());
