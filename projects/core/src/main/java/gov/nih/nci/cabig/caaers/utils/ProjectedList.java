...
public class ProjectedList<E> implements List<E>{
	...
	/**
	 * Will return true if the object<code>o</code> is available
	 * in the list that is decorated. The behaviour here is slightly different
	 * from the traditional behaviour of lists.
	 */
