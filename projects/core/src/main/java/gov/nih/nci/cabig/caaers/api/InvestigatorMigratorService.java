...
public interface InvestigatorMigratorService {
	...
	@WebMethod
	public ServiceResponse saveInvestigator(@WebParam(name="Staff") gov.nih.nci.cabig.caaers.integration.schema.investigator.Staff staff) throws RemoteException;
