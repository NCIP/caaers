...
public class ParticipantQueryTest extends TestCase {
    ...
    public void testFilterByNotMachingStudySiteId() throws Exception {
        ...
        assertTrue("missing paramenter name", participantQuery.getParameterMap().containsKey("firstName"));
        assertEquals("wrong parameter value", participantQuery.getParameterMap().get("firstName"), "%a%");
        assertTrue("missing paramenter name", participantQuery.getParameterMap().containsKey("studySiteId"));
        assertEquals("wrong parameter value", participantQuery.getParameterMap().get("studySiteId"), Integer.valueOf(1));
