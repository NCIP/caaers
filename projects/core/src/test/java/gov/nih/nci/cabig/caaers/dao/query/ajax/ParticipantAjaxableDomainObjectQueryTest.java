...
public class ParticipantAjaxableDomainObjectQueryTest extends TestCase {
    ...
    public void testQueryConstructor() throws Exception {
        ...
        assertEquals("wrong parsing for constructor",
                "Select participant.id,participant.firstName,identifier.value,identifier.primaryIndicator from Participant participant left join participant.identifiers as identifier order by participant.firstName", query
                        .getQueryString());
    ...
    public void testFilterByStudyId() throws Exception {
        ...
        assertEquals("Select participant.id,participant.firstName,identifier.value,identifier.primaryIndicator from Participant participant " +
