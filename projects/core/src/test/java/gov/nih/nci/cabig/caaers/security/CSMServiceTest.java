...
public class CSMServiceTest extends TestCase {
	...
	public void deleteProtectionElement(ProtectionElement protectionElement) throws Exception {
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		userProvisioningManager.removeProtectionElement(protectionElement.getProtectionElementId().toString());
	}
	
	public void deleteProtectionGroup(ProtectionGroup protectionGroup) throws Exception {
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		userProvisioningManager.removeProtectionGroup(protectionGroup.getProtectionGroupId().toString());
	}
	...
	public void removeProtectionElementFromProtectionGroup(ProtectionElement protectionElement, ProtectionGroup protectionGroup) throws Exception {
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		String protectionGroupId = protectionGroup.getProtectionGroupId().toString();
		String[] protectionElementIds = new String[]{protectionElement.getProtectionElementId().toString()};
		userProvisioningManager.removeProtectionElementsFromProtectionGroup(protectionGroupId, protectionElementIds);
	}
	...
	public void removePrivilegeFromRole(String privilegeName, Role role) throws Exception {
		...
		String[] privilegeIds = (String[])privilegeIdsSet.toArray(new String[privilegeIdsSet.size()]); 
		userProvisioningManager.assignPrivilegesToRole(roleId, privilegeIds);
	}
	
	public void removeProtectionGroupAndRoleFromGroup(ProtectionGroup protectionGroup, Role role, Group group) throws Exception {
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		String protectionGroupId = protectionGroup.getProtectionGroupId().toString();
		String groupId = group.getGroupId().toString();
		String[] roleIds = new String[]{role.getId().toString()};
		userProvisioningManager.removeGroupRoleFromProtectionGroup(protectionGroupId, groupId, roleIds);
	}
...
//	}
	...
	public void assignProtectionGroupAndRoleToGroup(ProtectionGroup protectionGroup, Role role, Group group) throws Exception {
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		String protectionGroupId = protectionGroup.getProtectionGroupId().toString();
		String groupId = group.getGroupId().toString();
		String[] roleIds = new String[]{role.getId().toString()};
		userProvisioningManager.assignGroupRoleToProtectionGroup(protectionGroupId, groupId, roleIds);
	}
	...
	public void assignProtectionElementToProtectionGroup(ProtectionElement protectionElement, ProtectionGroup protectionGroup) throws Exception {
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		String protectionGroupId = protectionGroup.getProtectionGroupId().toString();
		String[] protectionElementIds = new String[]{protectionElement.getProtectionElementId().toString()};
	...
	public ProtectionGroup buildProtectionGroup(String protectionGroupId,
			String protectionGroupName) throws Exception {
		...
		if (isEmpty(protectionGroupId)) {
			...
			protectionGroup = userProvisioningManager
					.getProtectionGroupById(protectionGroupId);
		}
	...
	public ProtectionElement buildProtectionElement(String peId, String objectId)
			throws Exception {
	...
	public UserProvisioningManager getUserProvisioningManager() {
		return (UserProvisioningManager) this.ctx
	...
	public User buildUser(String userId, String firstName, String lastName)
			throws Exception {
		User user = new User();
		UserProvisioningManager userProvisioningManager = getUserProvisioningManager();
		if (isEmpty(userId)) {
