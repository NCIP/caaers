...
public class TreeNodeTest extends TestCase {
    ...
    public void testFindSimplePropertyFrom() throws Exception {
        assertSinglePropertyValue("Wrong item found",
            "r.a", instance.getR().getA(),
            deepTree.find("r.a").getPropertyValuesFrom(instance));
        assertSinglePropertyValue("Should be no match",
            "r.a.a2", null,
            deepTree.find("r.a.a2").getPropertyValuesFrom(instance));
    }

    public void testFindSimplePropertyFromWithInterveningNull() throws Exception {
        instance.getR().setB(null);
        assertSinglePropertyValue("Should be null match",
            "r.b", null,
            deepTree.find("r.b").getPropertyValuesFrom(instance));
        assertSinglePropertyValue("Should be null match",
            "r.b.b1", null,
            deepTree.find("r.b.b1").getPropertyValuesFrom(instance));
    }
    ...
    public void testFindListPropertyFrom() throws Exception {
        ...
        assertEquals("Wrong number of values for populated list",
            2, deepTree.find("r.l[]").getPropertyValuesFrom(instance).getPropertyValues().length);
    }
    ...
    public void testFindPropertyOfListPropertyFrom() throws Exception {
        ...
        PropertyValue[] actualPVs = deepTree.find("r.l[].l7.l72").getPropertyValuesFrom(instance).getPropertyValues();
        assertEquals("Wrong number of values for populated list",
            3, actualPVs.length);
    ...
    private void assertPropertyValue(String msg, String expectedName, Object expectedValue, PropertyValue actualPV) {
    ...
    private static class L {
        ...
        public L7 getL7() { return l7; }
        public void setL7(L7 l7) { this.l7 = l7; }
        public String getL9() { return l9; }
        public void setL9(String l9) { this.l9 = l9; }
    }

    private static class L7 {
        private String l71, l72, l73;

        public String getL71() { return l71; }
        public void setL71(String l71) { this.l71 = l71; }
        public String getL72() { return l72; }
        public void setL72(String l72) { this.l72 = l72; }
        public String getL73() { return l73; }
        public void setL73(String l73) { this.l73 = l73; }
    }
