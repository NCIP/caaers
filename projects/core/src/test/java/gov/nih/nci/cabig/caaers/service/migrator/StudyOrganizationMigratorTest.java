...
import gov.nih.nci.cabig.caaers.service.migrator.StudyOrganizationMigrator;
...
public class StudyOrganizationMigratorTest extends AbstractTestCase {
	...
	public void testMigrate_CoordinatingCenter_InvalidOrganization() {
        ...
        EasyMock.expect(organizationDao.getByName(organization.getName())).andReturn(null);
