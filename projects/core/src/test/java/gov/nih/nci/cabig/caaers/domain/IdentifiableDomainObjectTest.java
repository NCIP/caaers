...
public class IdentifiableDomainObjectTest extends CaaersTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        identifiable.addIdentifier(Identifier.createTemplate("Hosp", "MRN", MRN));
        identifiable.getIdentifiers().get(0).setPrimaryIndicator(true);
        identifiable.addIdentifier(Identifier.createTemplate("Feds", "SSN", SSN));
        identifiable.addIdentifier(Identifier.createTemplate("IL", "DLN", DRIVERS_LICENSE));
    }
