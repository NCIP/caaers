...
public class StudyDaoTest extends DaoTestCase {
	...
	public void testForReport() {
		try {
           ...
           outputStream.println("Study , StudyAgent, TreatmentAssignment, CtepStudyDisease, CtepStudyDisease, StudySite, Organization");        
           outputStream.println("");   
           outputStream.println(""); 
           ...
           for (int j=0;j<studies.size();j++) {
        	   study = studies.get(j);
            	...
            	for (StudySite site:sites) {
            		...
            		outputStream.println(" Description : " + site.getOrganization().getDescriptionText());
            		outputStream.println(" NCI Identifier : " + site.getOrganization().getNciInstituteCode());
            	}
            	outputStream.println("");
            	outputStream.println(""); 
